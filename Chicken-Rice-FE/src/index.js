...
<AuthProvider>
  <HashRouter>
    ...
    <Routes>
      ...
      <Route path='/management/incommingOrders' element={   <Common><IncommingOrders/></Common> }/>
      ...
      <Route path='/order/report' element={<Common><Report/></Common>}/>
      <Route path='/finance/salesOrder' element={<Common><SalesOrder/></Common>}/>
      <Route path='/finance/invoicing' element={<Common><Invoicing/></Common>}/>
      <Route path='/finance/logManagement' element={<Common><LogManagement/></Common>}/>
      <Route path='/finance/ficedAssets' element={<Common><FixedAssets/></Common>}/>
      <Route path='/finance/storeCosting' element={<Common><StoreCosting/></Common>}/>
      <Route path='/purchase/requisition' element={<Common><Requisition/></Common>}/>
      <Route path='/purchase/order' element={<Common><Order/></Common>}/>
      <Route path='/purchase/expense' element={<Common><Expense/></Common>}/>
      <Route path='/purchase/supplier' element={<Common><Supplier/></Common>}/>
      <Route path='/HRMS' element={<Common sidebar={"HRMS"}><HRMS/></Common>}/>
      ...
      <Route path='/pos/setting/tables' element={<TablesManagement/>}/>
      ...
      <Route path='/configration/generalsetting' element={<Common><GeneralSetting/></Common>}/>
      <Route path='/configration/feacturesactivation' element={<Common><FeaturesActivation/></Common>}/>
      <Route path='/configration/language' element={<Common><Language/></Common>}/>
      <Route path='/configration/currency' element={<Common><Currency/></Common>}/>
      <Route path='/configration/taxes' element={<Common><Tax/></Common>}/>
      <Route path='/configration/pickuppoint' element={<Common><PickupPoint/></Common>}/>
      <Route path='/configration/smptsetting' element={<Common><SMPTSetting/></Common>}/>
      <Route path='/configration/paymentmethods' element={<Common><PaymentMethod/></Common>}/>
      <Route path='/configration/filesystemcredentials' element={<Common><FileSystemCredentials/></Common>}/>
      <Route path='/configration/sociallogin' element={<Common><SocialLogin/></Common>}/>
      <Route path='/configration/analyticstools' element={<Common><AnalyticsTools/></Common>}/>
      <Route path='/configration/googleRecaptchasettings' element={<Common><GoogleRecaptchaSettings/></Common>}/>

      <Route path='/posmain' element={<POSMain/>}/>
      <Route path='/pos/order/startsessions' element={<StartSession/>}/>
      <Route path='/pos/setting/transaction' element={<Transaction/>}/>
